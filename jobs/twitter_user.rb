...
SCHEDULER.every '10m', first_in: 0 do |job|
  begin
    ...
    puts '\e[33mFor the twitter_user widget to work,' +
         'you need to put in your twitter API keys in' +
         'the jobs/twitter_user.rb file.\e[0m'
    sleep 5
    retry if fuser_attempts < MAX_USER_ATTEMPTS
  end
end
